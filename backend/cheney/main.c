...
static char fat2[N] = "Y(ES(C(F=I0)1)(E(D*)I(FBI(F-I1))))\0";
static char teste[N] = "Y(ES(S(F<I2)I)(FS(S(FF(B+I)(F-I2))I)(F-I1)))\0";

int main(int n, char* args[]) {
    rootGrafo = gerarGrafo(teste);
    adicionarParametro(5);
    reduzirGrafo(0);
    printf("\n# Cheney #");
